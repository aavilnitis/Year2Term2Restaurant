...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('BBQ Wings', 2.99, 'Its finger lickin good', 549, 'starters', 'https://source.unsplash.com/CgXEzyC2fNA');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Bread Sticks', 1.99, 'Buttered bread sticks made in thailand', 249, 'starters', 'https://source.unsplash.com/N4gtuEZ5gWc');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Boring Salad', 4.99, 'The most boring food you can have!', 349, 'starters', 'https://source.unsplash.com/OzBLe_Eg1mg');
INSERT INTO menu_item_ingredient (menu_item_id, ingredient_id) VALUES (3, 25);

--MAINS GO HERE: 
--Inserting Cheeseburger and Ingredients
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Cheeseburger', 8.99, 'Juicy beef patty topped with melted cheese and served on a sesame seed bun.', 480, 'mains', 'https://source.unsplash.com/8l8Yl2ruUsg');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('BLT', 6.99, 'Crispy bacon, lettuce, and tomato served on white toast.', 720, 'mains', 'https://source.unsplash.com/J2uqFjeCuig');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Worlds Largest Pepperoni Pizza', 99999.99, 'Our magnum opus, an eighty inch pizza. You wont get it through your door!', 10999, 'mains', 'https://source.unsplash.com/MQUqbmszGGM');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Chalk', 777.99, 'Its just chalk.', 2199, 'sides', 'https://source.unsplash.com/mnxw8wYOV2s');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('French Fries', 2.99, 'The best fries in the world!', 399, 'sides', 'https://source.unsplash.com/wu8qWGLLMyI');
INSERT INTO menu_item_ingredient (menu_item_id, ingredient_id) VALUES (8, 26);

--Inserting Garlic bread and Ingredients
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Garlic Bread', 3.99, 'Buttered garlic bread', 199, 'sides', 'https://source.unsplash.com/nMWrV29cg6c');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Onion Rings', 4.99, 'Crispy clean onion rings', 599, 'sides', 'https://source.unsplash.com/HU_ubYnwElc');
INSERT INTO menu_item_ingredient (menu_item_id, ingredient_id) VALUES (10, 27);

--DESSERTS GO HERE:
--Inserting Chocolate brownie and Ingredients
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Chocolate Brownies', 5.29, 'Lots and lots of Chocolate!', 849, 'desserts', 'https://source.unsplash.com/VluG0SpIlrM');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Bubblegum Sundae', 4.99, 'Bubblegum sundae? Yes please!', 689, 'desserts', 'https://source.unsplash.com/GfwnPS3TTss');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Vanilla Cone', 4.99, 'A very boring dessert...', 579, 'desserts', 'https://source.unsplash.com/j3Y8xGrx0n8');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Coca-Cola', 2.99, 'Classic soda made with real sugar.', 40, 'drinks', 'https://source.unsplash.com/JKaKXJOIdeM');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Iced Tea', 2.49, 'Refreshing iced tea made with real tea leaves.', 5, 'drinks', 'https://source.unsplash.com/X6aY_j6JD_Y');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Lemonade', 2.99, 'Tart and sweet homemade lemonade.', 21, 'drinks', 'https://source.unsplash.com/p5EiqkBYIEE');
...
INSERT INTO menu_items (name, price, description, calories, type, picture) VALUES ('Toilet Water', 50000.99, 'Its better than you think', 102, 'drinks', 'https://source.unsplash.com/uvKGtMSrrD8');
