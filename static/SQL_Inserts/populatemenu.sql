...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('BBQ Wings', 2.99, 'Its finger lickin good', 549, 'starters');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Bread Sticks', 1.99, 'Buttered bread sticks made in thailand', 249, 'starters');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Boring Salad', 4.99, 'The most boring food you can have!', 349, 'starters');
INSERT INTO menu_item_ingredient (menu_item_id, ingredient_id) VALUES (3, 25);

--MAINS GO HERE: 
--Inserting Cheeseburger and Ingredients
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Cheeseburger', 8.99, 'Juicy beef patty topped with melted cheese and served on a sesame seed bun.', 480, 'mains');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('BLT', 6.99, 'Crispy bacon, lettuce, and tomato served on white toast.', 720, 'mains');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Worlds Largest Pepperoni Pizza', 99999.99, 'Our magnum opus, an eighty inch pizza. You wont get it through your door!', 10999, 'mains');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Chalk', 777.99, 'Its just chalk.', 2199, 'sides');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('French Fries', 2.99, 'The best fries in the world!', 399, 'sides');
INSERT INTO menu_item_ingredient (menu_item_id, ingredient_id) VALUES (8, 26);

--Inserting Garlic bread and Ingredients
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Garlic Bread', 3.99, 'Buttered garlic bread', 199, 'sides');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Onion Rings', 4.99, 'Crispy clean onion rings', 599, 'sides');
INSERT INTO menu_item_ingredient (menu_item_id, ingredient_id) VALUES (10, 27);

--DESSERTS GO HERE:
--Inserting Chocolate brownie and Ingredients
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Chocolate Brownies', 5.29, 'Lots and lots of Chocolate!', 849, 'desserts');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Bubblegum Sundae', 4.99, 'Bubblegum sundae? Yes please!', 689, 'desserts');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Vanilla Cone', 4.99, 'A very boring dessert...', 579, 'desserts');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Coca-Cola', 2.99, 'Classic soda made with real sugar.', 40, 'drinks');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Iced Tea', 2.49, 'Refreshing iced tea made with real tea leaves.', 5, 'drinks');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Lemonade', 2.99, 'Tart and sweet homemade lemonade.', 21, 'drinks');
...
INSERT INTO menu_items (name, price, description, calories, type) VALUES ('Toilet Water', 50000.99, 'Its better than you think', 102, 'drinks');
